...
class getSecurity_User_Provider_Concrete_InMemoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(['simoneguglielmi' => ['password' => 'dld=P@$gE*33S>[vn}chhUf_5./&.S%;44^,(y', 'roles' => [0 => 'ROLE_SUPER_USER']], 'admin' => ['password' => 'admin', 'roles' => [0 => 'ROLE_ADMIN']]]);
    }
}
