...
class getSecurity_User_Provider_Concrete_InMemoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(['myuser' => ['password' => 'mypassword', 'roles' => [0 => 'ROLE_USER']]]);
    }
}
